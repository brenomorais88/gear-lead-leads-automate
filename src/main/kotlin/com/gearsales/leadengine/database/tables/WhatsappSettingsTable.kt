...
object WhatsappSettingsTable : Table("whatsapp_settings") {
    ...
    val inboundNotifyRecipients = text("inbound_notify_recipients").default("")
    val inboundNotifyTemplateName = varchar("inbound_notify_template_name", 128).default("")
    val inboundNotifyTemplateLanguage = varchar("inbound_notify_template_language", 16).default("pt_BR")
    val inboundNotifyBodyTemplate = text("inbound_notify_body_template").default("")
